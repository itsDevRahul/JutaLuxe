export default function Policy() {
    return (
        <div className="container mx-auto text-lg py-10 sm:px-8 px-2">
            ...
            <p className="my-4">Last updated: June 18, 2024</p>
            <p className="my-4">
            ...
            <h2 className="text-3xl font-bold my-8">Interpretation and Definitions</h2>
            ...
            <ul className="list-disc px-6">
                ...
                <li>
                    <p className="my-4">
                        ...
                        "Us" or "Our" in this Agreement) refers to Juta Luxe, Jaipur, Rajsthan,
                        INDIA.
                    </p>
                </li>
                <li>
                ...
                <li>
                    <p className="my-4">
                        <strong>Website</strong> refers to Juta Luxe, accessible from{" "}
                        <a
                            href="http://localhost:3000"
                            rel="external nofollow noopener"
                            target="_blank"
                        >
                            http://www.jutaluxe.com
                        </a>
                    </p>
                </li>
                <li>
            ...
            <h2 className="text-3xl font-bold my-8">Collecting and Using Your Personal Data</h2>
            ...
            <ul className="list-disc px-6">
                ...
                <li>
                    <p className="my-4">Address, State, Province, ZIP/Postal code, City</p>
                </li>
                <li>
                    <p className="my-4">Usage Data</p>
                </li>
            </ul>
            <h4 className="text-xl font-bold">Usage Data</h4>
            ...
            <h3 className="text-2xl font-bold my-6">Retention of Your Personal Data</h3>
            <p className="my-4">
            ...
            <h3 className="text-2xl font-bold my-6">Transfer of Your Personal Data</h3>
            <p className="my-4">
            ...
            <h3 className="text-2xl font-bold my-6">Disclosure of Your Personal Data</h3>
            ...
            <h3 className="text-2xl font-bold my-6">Security of Your Personal Data</h3>
            <p className="my-4">
            ...
            <h2 className="text-3xl font-bold my-8">Children's Privacy</h2>
            <p className="my-4">
            ...
            <h2 className="text-3xl font-bold my-8">Links to Other Websites</h2>
            <p className="my-4">
            ...
            <h2 className="text-3xl font-bold my-8">Changes to this Privacy Policy</h2>
            <p className="my-4">
            ...
            <h2 className="text-3xl font-bold my-8">Contact Us</h2>
            <p className="my-4">
                If you have any questions about this Privacy Policy, You can contact us:
            </p>
            <ul className="list-disc px-6">
                <li>By email: office@jutaluxe.com</li>
            </ul>
        </div>
