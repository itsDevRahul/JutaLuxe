export default function TermsConditions() {
    return (
        <div className="container mx-auto text-lg py-10 sm:px-8 px-2">
            <h2 className="text-3xl font-bold my-8">
                Terms and Conditions
            </h2>
            <p className="my-4">Welcome to Juta Luxe!</p>
            <p className="my-4">
                These terms and conditions outline the rules and regulations for the use of
                Juta Luxe's Website, located at http://www.jutaluxe.com.
            </p>
            <p className="my-4">
                By accessing this website we assume you accept these terms and conditions.
                Do not continue to use Juta Luxe if you do not agree to take all of the
            ...
            <p className="my-4">
                ...
                of in. Any use of the above terminology or other words in the singular,
            ...
            <p className="my-4">
                We employ the use of cookies. By accessing Juta Luxe, you agreed to use
                cookies in agreement with the Juta Luxe's Privacy Policy.{" "}
            </p>
            <p className="my-4">
            ...
            <p className="my-4">
                Unless otherwise stated, Juta Luxe and/or its licensors own the intellectual
                property rights for all material on Juta Luxe. All intellectual property
                rights are reserved. You may access this from Juta Luxe for your own
                personal use subjected to restrictions set in these terms and conditions.
            </p>
            <p className="my-4">You must not:</p>
            <ul className="list-disc px-6">
                <li>Republish material from Juta Luxe</li>
                <li>Sell, rent or sub-license material from Juta Luxe</li>
                <li>Reproduce, duplicate or copy material from Juta Luxe</li>
                <li>Redistribute content from Juta Luxe</li>
            </ul>
            <p className="my-4">
            ...
            <p className="my-4">
                ...
                opinions and information in certain areas of the website. Juta Luxe does not
                filter, edit, publish or review Comments prior to their presence on the
                website. Comments do not reflect the views and opinions of Juta Luxe,its
                ...
                applicable laws, Juta Luxe shall not be liable for the Comments or for any
            ...
            <p className="my-4">
                Juta Luxe reserves the right to monitor all Comments and to remove any
                Comments which can be considered inappropriate, offensive or causes breach
                of these Terms and Conditions.
            </p>
            <p className="my-4">You warrant and represent that:</p>
            <ul className="list-disc px-6">
                <li>
            ...
            <p className="my-4">
                You hereby grant Juta Luxe a non-exclusive license to use, reproduce, edit
            ...
            <p className="my-4">
                ...
                compensates the absence of Juta Luxe; and (d) the link is in the context of
            ...
            <p className="my-4">
                ...
                e-mail to Juta Luxe. Please include your name, your organization name,
            ...
            <p className="my-4">Approved organizations may hyperlink to our Website as follows:</p>
            <ul className="list-disc px-6">
            ...
            <p className="my-4">
                No use of Juta Luxe's logo or other artwork will be allowed for linking
